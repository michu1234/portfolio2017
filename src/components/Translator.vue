	...
	<v-flex v-if="show2 === 1" class="translator container" xs12 sm6 offset-sm3>
		<v-card>
			<v-toolbar class="cyan" light>
				<v-toolbar-title><v-icon>translate &nbsp; </v-icon>Simple Translator <small>| powered by Yandex API</small></v-toolbar-title>
			...
			<div class="container">
				...
				<h5><strong>Original text:</strong> {{word_to_translate}}...</h5>
	...
	export default {
		...
		data() {
			...
			grab_data: function (word) {
				fetch('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20170706T220630Z.b3c8c9b12a1d0bb3.9dd94f7897ac1d37e6a1cf4902631a54ae7251b3&lang='+this.e1+'&text=' + word, {
					method: 'get'
