...
<div class="gallery">
	...
	<v-card v-if="onoff8 == 8">
		<v-card-row class="pink darken-4" light>
			<v-card-title>
				<span class="white--text">Gardener Portfolio</span>
				<v-spacer></v-spacer>
		...
		<v-card-row class="gallery__image" img="http://davedeveloper.eu/img/portfolio-site.jpg" height="350px"></v-card-row>
		...
		<v-card-row actions class="pink darken-3 mt-0">
			<a href="http://portfolio.davedeveloper.eu/" target="_blank">	<v-btn flat class="white--text">Try DEMO</v-btn></a>
			<v-spacer></v-spacer>
			<a href="https://github.com/michu1234/res-cv" target="_blank"><v-btn icon>
...
<script>
	export default {
		...
		data () {
			return {
				card_text: 'Proste portfolio dla branży ogrodniczej. Zawiera kilka podstron (w tym galeria) oraz mapkę dojazdu wykonaną na podstawie API od Google.',
				divider: '-----------------------',
