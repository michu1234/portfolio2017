<template>
  <div class="gallery">
    ...
    <v-card v-if="onoff9 == 9">
      <v-card-row class="blue-grey darken-3" light>
        <v-card-title>
          <span class="white--text">Marketing Agency</span>
          <v-spacer></v-spacer>
      ...
      <v-card-row actions class="blue-grey lighten-1 mt-0">
        <a href="http://marketing.davedeveloper.eu" target="_blank">
          <v-btn flat class="white--text">Try DEMO</v-btn>
        </a>
        <v-spacer></v-spacer>
        <a href="https://github.com/michu1234/marketing_agency" target="_blank">
          <v-btn icon>
